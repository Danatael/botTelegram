...
export async function GET() {
  try {
    ...
    // Título principal (más a la derecha y más pequeño)
    page.drawText('Reporte Corporativo', {
      x: 220, y: 690, size: 15, font, color: rgb(0.6, 0.1, 0.1)
    });

    // Coordenadas y estilos para la tabla (más abajo, letras más chicas y compactas)
